...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deletePersonCommand = "delp 9";
    ...
    public void execute_validCommand_success() throws Exception {
        ...
        assertCommandSuccess(listCommand, ListCommand.MESSAGE_SUCCESS_GLOBAL, model);
    }
    ...
    @Test
    public void getFilteredPersonListOfSelectedEvent_modifyList_throwsUnsupportedOperationException() {
        assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredPersonListOfSelectedEvent().remove(0));
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonEventBookStorage eventBookStorage = new JsonEventBookStorage(prefPath) {
            @Override
            public void saveEventBook(ReadOnlyEventBook eventBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
